# Seedance 2.5 Coordinate + Segmentation A/B

## Question

Do an explicit coordinate guide and an isolated target element improve a video
model's ability to animate the intended object while preserving the rest of the
scene?

## Controlled Setup

- Model: `doubao-seedance-2-5-260628`
- Task: reference-to-video from the same primary source image
- Duration: 4 seconds
- Resolution: 720p
- Audio: off
- Scene: two identical red mugs on one table
- Instruction: only the viewer-left mug rises and rotates; the right mug and
  scene stay fixed
