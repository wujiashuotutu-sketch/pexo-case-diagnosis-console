...
**Generation:** Mirror planned motives inside `[start-end]` prompt beats ("cut out on…", "match to…"). Do not write "quick cuts between scenes" without action/cause/beat language.
